...
export type DTIChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { newDTI: BigNumber; oldrDTI: BigNumber }
>;
...
export type RateChangedEvent = TypedEvent<
  [number, number],
  { newrateOfInterest: number; oldrateOfInterest: number }
>;
...
export interface Box extends BaseContract {
  ...
  functions: {
    ...
    LTV(overrides?: CallOverrides): Promise<[number]>;
    ...
    updateRate(
      newrateOfInterest: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    DTIChanged(newDTI?: null, oldrDTI?: null): DTIChangedEventFilter;
