...
export interface GovernorContractInterface extends utils.Interface {
  ...
  functions: {
    ...
    "malPractice(address,uint256)": FunctionFragment;
    ...
    "s_admin()": FunctionFragment;
    "s_lastProposal()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "s_admin", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "s_lastProposal",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "s_admin", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "s_lastProposal",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "adminChanged(address,address,uint256)": EventFragment;
  };
...
export type adminChangedEvent = TypedEvent<
  ...
  { prevAdmin: string; newAdmin: string; time: BigNumber }
>;
...
export interface GovernorContract extends BaseContract {
  ...
  functions: {
    ...
    s_admin(overrides?: CallOverrides): Promise<[string]>;

    s_lastProposal(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    userVotes(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    s_admin(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    s_admin(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    s_lastProposal(overrides?: CallOverrides): Promise<PopulatedTransaction>;
